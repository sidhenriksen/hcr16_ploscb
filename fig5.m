        ...
        for j = 1:length(sxs);
            ...
            for f = 1:length(fs_to_run);
                ...
                parfor k = 1:N;
                    ...
                    HM_antibem(k) = mean(antibem.simulate_spatiotemporal(halfmatched_rds,freq*duration,duration,bootstrap_mode));
                    C(k) = mean(cbem.simulate_spatiotemporal(correlated_rds,freq*duration,duration,bootstrap_mode));
                end
